...
const headwordOwnedSuffixesById = new Map([
  ...
  ["kv18-210", "て"], // はつ: 連用形「はて」の語尾で、接続助詞「て」ではなく見出し語の活用語尾。
  ["kv24-277", "けれ"], // ほいなし: 形容詞「なし」の已然形「なけれ」までが見出し語の活用形。
  ["kv30-352", "て"], // おきつ: 連用形「おきて」の語尾で、接続助詞「て」ではなく見出し語の活用語尾。
  ["kv32-376", "けれ"], // さうざうし: 已然形「さうざうしけれ」の語尾で、助動詞「けり」ではない。
  ["kv32-374", "けれ"], // うるさし: 已然形「うるさけれ」の語尾で、助動詞「けり」ではない。
  ["kv32-381", "けれ"], // つつまし: 已然形「つつましけれ」の語尾で、助動詞「けり」ではない。
  ["kv33-385", "けれ"], // ひとわろし: 已然形「ひとわろけれ」の語尾で、助動詞「けり」ではない。
  ["kv40-479", "給へ"], // いざさせたまへ: 底本の字面「いざさせ給へ」の「給へ」は見出し語の一部。
  ["kv42-494", "けれ"], // をかし: 已然形「をかしけれ」の語尾で、助動詞「けり」ではない。
  ["kv42-499", "けれ"], // こころぐるし: 已然形「心苦しけれ」の語尾で、助動詞「けり」ではない。
]);
